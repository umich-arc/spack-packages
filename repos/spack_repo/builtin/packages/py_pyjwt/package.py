...
class PyPyjwt(PythonPackage):
    ...
    version("2.13.0", sha256="41571c89ca91598c79e8ef18a2d07367d4810fbbd6f637794879baf1b7703423")
    ...
    depends_on("py-setuptools@77.0.3:", type="build", when="@2.13:")
    ...
    depends_on("py-typing-extensions@4:", type=("build", "run"), when="@2.13: ^python@:3.10")

    def url_for_version(self, version):
        url = "https://files.pythonhosted.org/packages/source/P/PyJWT/{}-{}.tar.gz"
        name = "pyjwt" if version >= Version("2.9") else "PyJWT"
