...
class PyTabulate(PythonPackage):
    ...
    pypi = "tabulate/tabulate-0.10.0.tar.gz"
    ...
    with default_args(deprecated=True):
        version(
            "0.8.10", sha256="6c57f3f3dd7ac2782770155f3adb2db0b1a269637e42f27599925e64b114f519"
        )
    ...
    with default_args(type=("build", "run")):
        depends_on("python@3.10:", when="@0.10:")  # https://pypi.org/project/tabulate/0.10.0
        depends_on("python@:3.10", when="@:0.9")  # https://pypi.org/project/tabulate/0.9.0
